...
### Search & Discovery
- **[SearXNG](https://docs.searxng.org/)** - SearXNG Team - AGPLv3 License
  - Privacy-respecting, self-hosted metasearch engine
  - Aggregates results from multiple search engines without tracking
  - Provides web search context for Bee AI report generation
  - Enables local-first web research without external API dependencies
