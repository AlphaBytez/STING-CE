...
const EmailFirstLogin = () => {
  ...
  const handleEmailSubmit = async (e) => {
    ...
    try {
      ...
      const response = await axios.post(cleanActionUrl(flow.ui.action), params.toString(), {
        headers: { 
  ...
  const handleCodeSubmit = async (e) => {
    ...
    try {
      ...
      const response = await axios.post(cleanActionUrl(flowData.ui.action), params.toString(), {
        headers: { 
          'Accept': 'application/json',
          'Content-Type': 'application/x-www-form-urlencoded'
        },
