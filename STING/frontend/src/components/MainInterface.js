...
const MainInterface = () => {
  ...
  // Check if user is admin - SECURITY: Only trust Kratos traits, never localStorage
  const isAdmin = identity?.traits?.role === 'admin' || identity?.traits?.role === 'super_admin';
        ...
        <div className="flex justify-between items-center h-full">
          <div className="flex items-center gap-3">
            ...
            <div className="flex items-baseline gap-3">
              <span className="text-xl font-bold" style={{ color: 'var(--color-text)', lineHeight: 1 }}>Hive</span>
              <span style={{ color: 'var(--color-text-tertiary)' }}>|</span>
              <span className="text-lg font-medium" style={{ color: 'var(--color-text)', lineHeight: 1 }}>
