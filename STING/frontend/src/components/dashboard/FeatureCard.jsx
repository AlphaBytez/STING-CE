...
const FeatureCard = ({ 
  ...
  return (
    <div
      onClick={handleClick}
      className={`
        dashboard-card relative overflow-hidden p-4 sm:p-5 md:p-6 transition-all duration-300
        ${locked
          ? 'cursor-not-allowed opacity-60'
          : comingSoon
          ? 'cursor-not-allowed'
          : 'hover:border-yellow-500/50 hover:shadow-lg sm:hover:scale-[1.02] cursor-pointer'
        }
      `}
    >
      {comingSoon && (
