...
import { 
  Activity, Shield, MessageSquare, Database, 
  ...
  return (
    <div className="p-4 sm:p-6 max-w-7xl mx-auto">
        ...
        <div className="mb-6 sm:mb-8">
          <h1 className="text-2xl sm:text-3xl font-bold text-yellow-400 mb-1 sm:mb-2">Welcome back, {identity?.traits?.profile?.displayName || identity?.traits?.name?.first || 'Beekeeper'}!</h1>
          <p className="text-sm sm:text-base text-gray-400">Monitor your hive's security posture and manage your swarm</p>
        </div>
