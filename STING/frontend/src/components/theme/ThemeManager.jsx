...
export const THEME_CONFIG = {
  ...
  [THEMES.ASCII]: {
    name: 'ASCII Art',
    description: 'Pure text-based UI with box-drawing characters, black background + STING yellow',
    category: 'Special',
    performance: 'Maximum Performance',
    features: ['Box-drawing', 'Pure text', 'Monospace', 'ASCII art', 'STING yellow'],
    preview: '/theme-previews/ascii.png'
  }
};
  ...
  useEffect(() => {
    ...
    const loadThemeCSS = (theme) => {
      ...
      const themeCSS = {
        ...
        [THEMES.ASCII]: '/theme/ascii-theme.css'
