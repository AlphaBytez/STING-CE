...
import QABeeReviewDashboard from './QABeeReviewDashboard';
        ...
        <div className="bg-slate-800/30 backdrop-blur-sm rounded-3xl p-8 border border-slate-700/50">
          ...
          {activeTab === 'qa-bee' && (
            <div className="bg-gradient-to-br from-emerald-500/5 to-cyan-500/5 rounded-2xl p-1 border border-emerald-500/20">
              <QABeeReviewDashboard />
            </div>
          )}

          {activeTab === 'maintenance' && (
            <div className="bg-gradient-to-br from-orange-500/5 to-amber-500/5 rounded-2xl p-1 border border-orange-500/20">
              <MaintenanceManager />
            </div>
          )}
        </div>
