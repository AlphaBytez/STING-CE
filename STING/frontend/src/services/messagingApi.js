...
// Using external-ai service which stores conversations in PostgreSQL + Redis
// This ensures chat and history use the same data source
const BEE_API_URL = window.env?.REACT_APP_BEE_API_URL ||
                    process.env.REACT_APP_BEE_API_URL ||
                    '/api/external-ai';  // Use proxy route to external-ai service
