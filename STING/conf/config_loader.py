...
class ConfigurationManager:
    ...
    def _generate_kratos_env_vars(self):
        ...
        # Fixed: Use PUBLIC_URL from processed_config (frontend at port 8443)
        # NOT frontend.react.api_url which is the backend API URL at port 5050
        frontend_url = self.processed_config.get('PUBLIC_URL', f"{protocol}://{domain}:{ports.get('frontend', 8443)}")
