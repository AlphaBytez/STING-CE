-- STING Complete Database Schema
-- This file contains the complete current schema for fresh installations
-- Generated from existing production database schema
-- Includes all preference management columns added in recent updates
...
CREATE TYPE report_status AS ENUM ('pending', 'queued', 'processing', 'completed', 'failed', 'cancelled');
...
CREATE TABLE IF NOT EXISTS user_settings (
    ...
    created_at TIMESTAMP WITHOUT TIME ZONE DEFAULT CURRENT_TIMESTAMP,
    updated_at TIMESTAMP WITHOUT TIME ZONE DEFAULT CURRENT_TIMESTAMP,
    -- New preference management columns
...
CREATE TABLE IF NOT EXISTS passkeys (
    ...
    metadata JSONB,
    -- Additional columns from migration 005
    name VARCHAR(255),
...
-- Create function to cleanup expired passkey challenges
...
-- Registration challenge indexes
...
-- Authentication challenge indexes
